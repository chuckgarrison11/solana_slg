...
export const Navbar = () => {
  return (
    <div className='bg-black'>
      <div className='px-4'>
      <div className='py-4 flex items-cencer justify-between'>
        <div className='relative'>
          <div className='absolute w-full h-full top-2 bottom-0 bg-[linear-gradient(to_right,#F87BFF,#FB92CF,#FFDD9B,#C2F0B1,#2FD8FE)] blur-md'></div>
        </div>
        ...
        <nav className='gap-6 items-center hidden sm:flex'>
          ...
          <a href="https://form.jotform.com/250372583911154" target='_blank' rel="noopener noreferrer"><button className='bg-white py-2 px-4 rounded-lg'>Sign Up</button></a>
        </nav>
      </div>
    </div>
    </div>
